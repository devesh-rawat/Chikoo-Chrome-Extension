...
const StickyNotesComponent = (() => {
  ...
  function _triggerPigeonDelivery(text, colorKey, onComplete) {
    ...
    flightEl.innerHTML = `
      <div class="pigeon-bird">
        <svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor"><path d="M20.24 12.24a6 6 0 0 0-8.49-8.49L5 10.5V19h8.5z"/><line x1="16" y1="8" x2="2" y2="22" stroke="currentColor" stroke-width="2"/><line x1="17.5" y1="15" x2="9" y2="15" stroke="currentColor" stroke-width="2"/></svg>
      </div>
      <div class="pigeon-letter" style="background-color: ${colorHex};">
        <svg viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="2" style="vertical-align:-1px;margin-right:3px;"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
        ${snippet}
      </div>
    `;
