...
const SearchComponent = (() => {
  const ENGINES = [
    { name: 'Google',     url: 'https://www.google.com/search?q=',       label: 'Google',     icon: '🔍' },
    { name: 'DuckDuckGo', url: 'https://duckduckgo.com/?q=',             label: 'DuckDuckGo', icon: '🦆' },
    { name: 'Brave',      url: 'https://search.brave.com/search?q=',     label: 'Brave',      icon: '🦁' },
    { name: 'YouTube',    url: 'https://www.youtube.com/results?search_query=', label: 'YouTube', icon: '▶️' },
    { name: 'Perplexity', url: 'https://www.perplexity.ai/search?q=',    label: 'Perplexity', icon: '🧠' },
    { name: 'Bing',       url: 'https://www.bing.com/search?q=',         label: 'Bing',       icon: '🌐' }
  ];
  ...
  function _syncAllPills() {
    _instances.forEach((container) => {
      ...
      if (pill) pill.textContent = `${ENGINES[_idx].icon} ${ENGINES[_idx].label}`;
