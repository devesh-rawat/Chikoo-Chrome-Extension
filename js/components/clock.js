...
const ClockComponent = (() => {
  ...
  function _updateWeatherUI() {
    ...
    container.innerHTML = `
      <div class="clock-weather-main">
        <div class="clock-weather-icon">${_weatherData.icon}</div>
  ...
  function _showWeatherError() {
    ...
    retry?.addEventListener('click', () => {
      container.innerHTML = `<div class="clock-weather-loading"><span class="weather-loading-text">Loading weather...</span></div>`;
